...
export const FamilyOversight: React.FC<FamilyOversightProps> = ({ isActive = false }) => {
  ...
  return (
    <div className="w-full max-w-[280px]">
          ...
          {/* Team Card */}
          <div className={`bg-white dark:bg-[#121a26] border rounded-xl p-4 transition-colors duration-200 ${
               isActive 
                ...
                >
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {i === 0 && (
                           <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border transition-colors duration-200 ${
                             isActive 
